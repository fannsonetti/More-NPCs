...
namespace MoreNPCs.NPCs
{
    public sealed class ManholeMike : NPC
    {
        ...
        protected override void ConfigurePrefab(NPCPrefabBuilder builder)
        {
            ...
            Vector3 underParkingChill = new Vector3(1.25f, -4.035f, 77.25f);
            ...
            builder.WithIdentity("manhole_mike", "Manhole Mike", "")
                .WithAppearanceDefaults(av =>
                {
                    ...
                    av.LeftEye = (0.21f, 0.49f);
                    av.RightEye = (0.21f, 0.49f);
                ...
                .WithRelationshipDefaults(r =>
                {
                    r.WithDelta(2.0f)
                        ...
                        .WithConnectionsById("cranky_frank", "anna_chesterfield", "mack", "grunk");
                })
                .WithSchedule(plan =>
                {
                    ...
                    plan.Add(new WalkToSpec { Destination = sewerStorageChill, StartTime = 1812, FaceDestinationDirection = true, Forward = Quaternion.Euler(0, 210, 0) * Vector3.forward });
