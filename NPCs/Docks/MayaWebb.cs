        ...
        protected override void ConfigurePrefab(NPCPrefabBuilder builder)
        {
            ...
            builder.WithIdentity("maya_webb", "Maya", "Webb")
                .WithAppearanceDefaults(av =>
                {
                    ...
                    av.WithFaceLayer("Avatar/Layers/Face/Freckles", new Color(0.48f, 0.36f, 0.28f));
                ...
                .WithCustomerDefaults(cd =>
                {
                    cd.WithSpending(minWeekly: 600f, maxWeekly: 1000f)
                        ...
                        .WithPreferredProperties(Property.Seizure, Property.Refreshing, Property.ThoughtProvoking);
                })
