...
namespace MoreNPCs.NPCs
{
    public sealed class DamonRusk : NPC
    {
        ...
        protected override void ConfigurePrefab(NPCPrefabBuilder builder)
        {
            ...
            var elevator = Building.GetByName("Storage Warehouse Elevator");
            ...
            builder.WithIdentity("damon_rusk", "Damon", "Rusk")
                ...
                .WithSchedule(plan =>
                {
                    ...
                    plan.Add(new StayInBuildingSpec { BuildingName = "Small Tower", StartTime = 1810, DurationMinutes = 149 });
                    plan.Add(new WalkToSpec { Destination = townCenter, StartTime = 2040, FaceDestinationDirection = true });
                    plan.StayInBuilding(elevator, 2135, 764);
                });
        }
