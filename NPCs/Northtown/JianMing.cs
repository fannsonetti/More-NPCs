            ...
            builder.WithIdentity("jian_ming", "Jian", "Ming")
                ...
                .WithCustomerDefaults(cd =>
                {
                    cd.WithSpending(minWeekly: 300f, maxWeekly: 600f)
                        ...
                        .WithPreferredProperties(Property.Slippery, Property.Refreshing, Property.ThoughtProvoking);
                })
                ...
                .WithSchedule(plan =>
                {
                    ...
                    plan.StayInBuilding(northIndustrial, 1051, 217);
                    plan.StayInBuilding(chineseRestaurant, 1309, 876); // merged evening + overnight stay
                });
        }
