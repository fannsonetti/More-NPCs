    ...
    public sealed class SiennaCrowley : NPC
    {
        ...
        protected override void ConfigurePrefab(NPCPrefabBuilder builder)
        {
            ...
            builder.WithIdentity("sienna_crowley", "Sienna", "Crowley")
                ...
                .WithRelationshipDefaults(r => r.WithDelta(2.0f).SetUnlocked(false).SetUnlockType(NPCRelationship.UnlockType.DirectApproach).WithConnectionsById("lucy_pennington", "jennifer_rivera"))
                .WithSchedule(plan =>
                {
