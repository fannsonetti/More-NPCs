...
{
    /// <summary>Persists Silas's assigned dealers and stored earnings.</summary>
    public sealed class SilasSupervisorSave : Saveable
    {
        public static SilasSupervisorSave? Instance { get; private set; }
        ...
        public SilasSupervisorSave() => Instance = this;
